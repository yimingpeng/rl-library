...
public class ManOnHotPlateVizComponent implements SelfUpdatingVizComponent, Observer {
    ...
    public ManOnHotPlateVizComponent(HotPlateVisualizer mc) {
        this.mcv = mc;
        mc.getTheGlueState().addObserver(this);
        URL carImageNeutralURL = ManOnHotPlateVizComponent.class.getResource("/images/auto.png");
        URL carImageLeftURL = ManOnHotPlateVizComponent.class.getResource("/images/auto_left.png");
        URL carImageRightURL = ManOnHotPlateVizComponent.class.getResource("/images/auto_right.png");
        try {
