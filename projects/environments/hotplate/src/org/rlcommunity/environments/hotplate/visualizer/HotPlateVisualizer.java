...
import org.rlcommunity.environments.hotplate.messages.MCGoalRequest;
import org.rlcommunity.environments.hotplate.messages.MCGoalResponse;
import org.rlcommunity.environments.hotplate.messages.MCHeightRequest;
import org.rlcommunity.environments.hotplate.messages.MCHeightResponse;
import org.rlcommunity.environments.hotplate.messages.MCStateRequest;
...
public class HotPlateVisualizer extends AbstractVisualizer implements ValueFunctionDataProvider, AgentOnValueFunctionDataProvider, GlueStateProvider {
    ...
    protected void setupVizComponents() {
        ...
        SelfUpdatingVizComponent carOnMountain = new ManOnHotPlateVizComponent(this);
