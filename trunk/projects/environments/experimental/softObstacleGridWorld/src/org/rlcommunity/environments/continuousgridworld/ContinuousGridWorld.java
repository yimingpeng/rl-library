...
//		String oldTaskSpecString=taskSpecVersion+":e:2_[f,f]_["+getWorldRect().getMinX()+","+getWorldRect().getMaxX()+"]_["+getWorldRect().getMinY()+","+getWorldRect().getMaxY()+"]:1_[i]_[0,3]:[-1,1]";
	}
