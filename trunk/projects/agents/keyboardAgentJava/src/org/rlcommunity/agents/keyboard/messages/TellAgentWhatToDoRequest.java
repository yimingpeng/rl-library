...
public class TellAgentWhatToDoRequest extends AgentMessages{

	public TellAgentWhatToDoRequest(GenericMessage theMessageObject) {
		super(theMessageObject);
	}

        public static TellAgentWhatToDoResponse Execute(int[] whichAction) {
            StringBuffer payloadBuffer=new StringBuffer();
            payloadBuffer.append("SETACTION");
            for(int thisAction:whichAction){
		...
		TellAgentWhatToDoResponse theResponse;
		try{
		theResponse = new TellAgentWhatToDoResponse(responseMessage);
