...
----------------------------------------------------
Running your first experiment is as simple as choosing a trainer and an agent and running the run.bash script in each of their directories.  For example, to run the random agent on any of the Java domains, open two terminal windows:
...
----------------------------------------------------
Running a console experiment is very similar to running a graphical experiment, you need to choose a trainer and an agent.  By default, the trainers are set to run 10 episodes of mountain car (should be clear from the src of the console trainer).  For example, to run this default mountain car experiment, open two terminal windows:
