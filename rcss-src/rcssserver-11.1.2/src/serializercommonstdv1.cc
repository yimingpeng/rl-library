...
void
SerializerCommonStdv1::serializeParam( std::ostream&, int ) const
{}

void
SerializerCommonStdv1::serializeParam( std::ostream&, unsigned int ) const
{}

void
SerializerCommonStdv1::serializeParam( std::ostream&, bool ) const
{}

void
SerializerCommonStdv1::serializeParam( std::ostream&, double ) const
{}

void
SerializerCommonStdv1::serializeParam( std::ostream&, const std::string& ) const
{}
