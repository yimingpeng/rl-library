...
public class CRWMapResponse extends AbstractResponse{
	...
	public CRWMapResponse(Rectangle2D theWorldRect, Vector<Rectangle2D> resetRegions,	Vector<Rectangle2D> rewardRegions,	Vector<Double> theRewards,	Vector<Rectangle2D> barrierRegions,
	Vector<Double> thePenalties) {
	...
	public CRWMapResponse(String responseMessage) throws NotAnRLVizMessageException {
	...
	public String toString() {
		String theResponse="CRWMapResponse: not implemented ";
		return theResponse;
	}
