...
int
gzstreambuf::readData( char* dest, int& dest_size )
{
...
gzstream::gzstream( std::streambuf& strm, unsigned int buffer_size )
    : gzstreambuf( strm, buffer_size ),
      std::iostream( this )
{
}

gzstream::gzstream( std::iostream& strm, unsigned int buffer_size )
    : gzstreambuf( *(strm.rdbuf()), buffer_size ),
      std::iostream( this )
{
}
...
gzistream::gzistream( std::streambuf& src, unsigned int buffer_size )
    : gzstreambuf( src, buffer_size ),
      std::istream( this )
{
}

gzistream::gzistream( std::istream& src, unsigned int buffer_size )
    : gzstreambuf( *(src.rdbuf()), buffer_size ),
      std::istream( this )
{
}
...
gzostream::gzostream( std::streambuf& dest, unsigned int buffer_size )
    : gzstreambuf( dest, buffer_size ),
      std::ostream( this )
{
}

gzostream::gzostream( std::ostream& dest, unsigned int buffer_size )
    : gzstreambuf( *(dest.rdbuf()), buffer_size ),
      std::ostream( this )
{
}
