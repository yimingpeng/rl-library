...
void
SerializerCommonStdv8::serializeParam( std::ostream& strm, const std::string& name, int param ) const
{ strm << "(" << name << " " << param << ")"; }

void
SerializerCommonStdv8::serializeParam( std::ostream& strm, const std::string& name, bool param ) const
{ strm << "(" << name << " " << param << ")";}

void
SerializerCommonStdv8::serializeParam( std::ostream& strm, const std::string& name, double param ) const
{ strm << "(" << name << " " << param << ")";}

void
SerializerCommonStdv8::serializeParam( std::ostream& strm, const std::string& name, const std::string& param ) const
{ strm << "(" << name << " \"" << param << "\")";}
